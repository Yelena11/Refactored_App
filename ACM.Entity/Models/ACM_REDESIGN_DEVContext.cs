...
{
    public partial class ACM_REDESIGN_DEVContext : DbContext
    {
        static ACM_REDESIGN_DEVContext()
        {
            Database.SetInitializer<ACM_REDESIGN_DEVContext>(null);
        }

        public ACM_REDESIGN_DEVContext()
            : base("Name=ACM_REDESIGN_DEVContext")
        {
        }
        ...
        public DbSet<AdSchedulingCondition> AdSchedulingConditions { get; set; }
        public DbSet<ATMAdDisplayRule> ATMAdDisplayRules { get; set; }
        public DbSet<ATMCampaignDisplayRule> ATMCampaignDisplayRules { get; set; }
        ...
        public DbSet<CampaignSchedulingCondition> CampaignSchedulingConditions { get; set; }
        ...
        public DbSet<RegionAdDisplayRule> RegionAdDisplayRules { get; set; }
        public DbSet<RegionCampaignDisplayRule> RegionCampaignDisplayRules { get; set; }
        ...
        public DbSet<StateAdDisplayRule> StateAdDisplayRules { get; set; }
        public DbSet<StateCampaignDisplayRule> StateCampaignDisplayRules { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new AdSchedulingConditionMap());
            modelBuilder.Configurations.Add(new ATMAdDisplayRuleMap());
            modelBuilder.Configurations.Add(new ATMCampaignDisplayRuleMap());
            ...
            modelBuilder.Configurations.Add(new CampaignSchedulingConditionMap());
            ...
            modelBuilder.Configurations.Add(new RegionAdDisplayRuleMap());
            modelBuilder.Configurations.Add(new RegionCampaignDisplayRuleMap());
            ...
            modelBuilder.Configurations.Add(new StateAdDisplayRuleMap());
            modelBuilder.Configurations.Add(new StateCampaignDisplayRuleMap());
