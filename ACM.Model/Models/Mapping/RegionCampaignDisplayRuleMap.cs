...
{
    public class RegionCampaignDisplayRuleMap : EntityTypeConfiguration<RegionCampaignDisplayRule>
    {
        public RegionCampaignDisplayRuleMap()
        {
            // Primary Key
            this.HasKey(t => t.ID);
            ...
            this.ToTable("RegionCampaignDisplayRules");
            ...
            this.HasRequired(t => t.Campaign)
                .WithMany(t => t.RegionCampaignDisplayRules)
